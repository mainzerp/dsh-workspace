...
export async function apply(ctx: ClientContext): Promise<void> {
  ...
  ctx.effect(() => {
    ...
    const style = document.createElement('style'); style.id = STYLE_ID; style.textContent = STYLES + STATUS_STYLES + BASE_STYLES + FLAT_STYLES + EDITOR_STYLES + GRAPH_STYLES; document.head.append(style)
    return () => style.remove()
