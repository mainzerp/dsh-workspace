...
export function logUsage(events, startTime, now) {
    const steps = new Map();
    ...
    const totals = { apiRequests: 0, inputTokens: 0, outputTokens: 0, cacheReadTokens: 0, cacheWriteTokens: 0, totalTokens: 0, models: [] };
...
export function aggregateUsage(usages, now, startTime) {
