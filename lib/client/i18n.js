...
const en = {
    ...
    refBranch: (name) => `Branch ${name}`,
    refRemote: (name) => `Remote branch ${name}`,
    ...
    editorSaveFailed: (reason) => `Failed to save: ${reason}`,
    editorSaved: 'Saved',
    upload: 'Upload file to project root',
    uploadOverwriteConfirm: (name) => `${name} already exists. Overwrite it?`,
    uploadFailed: (reason) => `Upload failed: ${reason}`,
    uploadDone: (name) => `Uploaded ${name}`,
...
const de = {
    ...
    editorSaveFailed: (reason) => `Speichern fehlgeschlagen: ${reason}`,
    editorSaved: 'Gespeichert',
    upload: 'Datei in das Projektverzeichnis hochladen',
    uploadOverwriteConfirm: (name) => `${name} existiert bereits. Überschreiben?`,
    uploadFailed: (reason) => `Hochladen fehlgeschlagen: ${reason}`,
    uploadDone: (name) => `${name} hochgeladen`,
