...
export const DAYBAR_TICKS = [0.25, 0.5, 0.75];
function norm(value) {
 ...
 */
export function weekdayAt(epochMs) {
 ...
 */
export function computeDayBar(nowMs, timezoneOffsetMinutes, peakWindows, peakWeekdays = DEFAULT_PEAK_WEEKDAYS) {
