...
function HarnessSummary({ wide, sessions }) {
    ...
    return _jsxs("div", { className: `hui-summary${wide ? '' : ' rail'}`, children: [_jsxs("div", { className: "hui-summary-main", "aria-label": t.balanceStatus, title: snapshot?.balance.error, children: [wide ? _jsxs("span", { className: "hui-content", children: [_jsxs("span", { className: "hui-period", "data-period": period, title: period === 'idle' ? t.offPeakBillingPeriod : t.peakBillingPeriod, children: [_jsx("i", {}), period === 'idle' ? t.offPeak : t.peak] }), _jsx("span", { className: "hui-balance-line", children: _jsx("b", { "data-tone": balanceTone, children: balanceValue }) })] }) : _jsx("span", { className: "hui-period", "data-period": period, title: period === 'idle' ? t.offPeakBillingPeriod : t.peakBillingPeriod, children: _jsx("i", {}) }), wide && dayBar !== null ? _jsxs("div", { className: "hui-daybar", role: "img", "aria-label": t.dayBarSchedule, title: t.dayBarSchedule, children: [dayBar.segments.map((segment, index) => _jsx("span", { className: "hui-daybar-peak", style: { left: `${segment.start * 100}%`, width: `${(segment.end - segment.start) * 100}%` } }, index)), DAYBAR_TICKS.map(fraction => _jsx("span", { className: "hui-daybar-tick", style: { left: `${fraction * 100}%` } }, fraction)), _jsx("span", { className: "hui-daybar-marker", style: { left: `${dayBar.markerFraction * 100}%` } })] }) : null] }), _jsx(ProjectDrawer, { sessionId: sessionId, cwd: cwd })] });
}
