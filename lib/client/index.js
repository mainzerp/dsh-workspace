...
function HarnessSummary({ wide, sessions }) {
    ...
    return _jsxs("div", { className: `hui-summary${wide ? '' : ' rail'}`, children: [_jsx("div", { className: "hui-summary-main", "aria-label": "Balance status", title: snapshot?.balance.error, children: wide ? _jsxs("span", { className: "hui-content", children: [_jsx("span", { className: "hui-card-head", children: _jsxs("span", { className: "hui-period", "data-period": period, title: period === 'idle' ? 'Off-peak billing period' : 'Peak billing period', children: [_jsx("i", {}), period === 'idle' ? 'Off-peak' : 'Peak'] }) }), _jsxs("span", { className: "hui-balance-line", children: [_jsx("b", { "data-tone": balanceTone, children: balanceValue }), _jsx("small", { children: "Balance" })] })] }) : _jsx("span", { className: "hui-period", "data-period": period, title: period === 'idle' ? 'Off-peak billing period' : 'Peak billing period', children: _jsx("i", {}) }) }), _jsx(ProjectDrawer, { sessionId: sessionId, cwd: cwd })] });
}
